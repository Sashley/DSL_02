...
def main():
    ...
    json_file = current_dir / "dsl" / "output" / "json" / "shipping.json"
    templates_dir = current_dir / "app" / "templates" / "crud"
    routes_dir = current_dir / "app" / "routes" / "crud"
    relationships_dir = current_dir / "app" / "utils" / "relationships"
