...
from app.models.shipping import S005_Container, S012_Port
from app import db
...
relationships = [{'field_name': 'port_id', 'target_model': 'S012_Port', 'relationship_field': 'port'}]
...
def list_s005_container():
    ...
    if relationships:  # Only add joinedload if there are relationships
        query = query.options(*[
            db.joinedload(getattr(S005_Container, rel["relationship_field"]))
