...
from app.models.shipping import S009_Vessel, S008_ShippingCompany
from app import db
...
relationships = [{'field_name': 'shipping_company_id', 'target_model': 'S008_ShippingCompany', 'relationship_field': 'shipping_company'}]
...
def list_s009_vessel():
    ...
    if relationships:  # Only add joinedload if there are relationships
        query = query.options(*[
            db.joinedload(getattr(S009_Vessel, rel["relationship_field"]))
